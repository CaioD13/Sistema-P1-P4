...
def normalizar_re(re_raw: str) -> str:
    ...
    # Se tem 7 dígitos, assume que o último é dígito verificador → remove
    if len(somente_digitos) == 7:
        return somente_digitos[:-1]
    
    # Se tem 6 dígitos ou menos, mantém como está (já é o RE sem dígito)
